        ...
        >
            ...
            <div id={'file-block-container'} className={'flex flex-row h-full w-screen justify-center items-center'}
                ...
                <div id={'file-tools'}
                    ...
                    <Button
                        id={'icon-upload'}
                        className={'flex flex-row items-center justify-center bg-emerald-500 hover:bg-emerald-400 shadow-lg transition-all duration-300 rounded-lg h-fit py-2 w-full ml-2'}
